...
const fillingColorMap: Record<FillingType, string> = {
  redBean: "#a44b3c",
  caramel: "#d09e6f",
  chestnut: "#a58a71",
};
  ...
  return (
    ...
    >
      ...
      <path
        style={{
          fill: isHoveringFilling
            ? lighten(fillingColorMap[filling], 0.2)
            : fillingColorMap[filling],
          cursor: "pointer",
          transition: "0.2s",
        }}
      ...
      <path
        style={{
          stroke: isHoveringCake
            ? lighten(cakeColorMap[cake].cakeColor, 0.2)
            : cakeColorMap[cake].cakeColor,
      ...
      <path
        style={{
          stroke: isHoveringCake
            ? lighten(cakeColorMap[cake].outlineColor, 0.2)
            : cakeColorMap[cake].outlineColor,
